...
resource "aws_instance" "my_instance1" {
  ...
  security_groups = [data.aws_security_group.public-security_group_id.id] #without security group can not connect to ec2 ssh port needs to be open for 0.0.0.0/0
